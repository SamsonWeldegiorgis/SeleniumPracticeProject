...
public class T04_NextCBM_Login_PositiveSenario {
    ...
    public static void main(String[] args) {
        ...
        loginText.sendKeys("helpdesk5@cybertekschool.com " + Keys.ENTER);

        // Password by name
        WebElement passWordText = driver.findElement(By.name("USER_PASSWORD"));
        passWordText.sendKeys("UserUser" + Keys.ENTER); // UserUser
